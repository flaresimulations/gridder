...
def get_and_write_ovdengrid(filepath, zoom_ncells, zoom_width, njobs):
    ...
    for jobid in range(njobs):
        ...
        grid_grp = hdf["Grids"]
        zoom_grp = grid_grp[str(zoom_width) + "_" + str(zoom_ncells)]

        mass_grid += zoom_grp["Mass_grid"][:]
...
for zoom_ncells in [16, 32, 64, 128, 256]:
    ...
    get_and_write_ovdengrid(filepath, zoom_ncells, zoom_width, njobs)
