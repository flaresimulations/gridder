...
public:
  ...
  bool outsideKernel(std::shared_ptr<GridPoint> grid_point,
    ...
    //     centre const double dx = std::min({fabs(nearest(thisx_min - gridx,
    //     dim[0])),
    //                                 fabs(nearest(thisx_max - gridx,
    //                                 dim[0]))});
    //     const double dy = std::min({fabs(nearest(thisy_min - gridy, dim[1])),
    //                                 fabs(nearest(thisy_max - gridy,
    //                                 dim[1]))});
    //     const double dz = std::min({fabs(nearest(thisz_min - gridz, dim[2])),
    //                                 fabs(nearest(thisz_max - gridz,
    //                                 dim[2]))});
    ...
    //                 dx, dy, dz, p_r2, kernel_rad2, this->loc[0],
